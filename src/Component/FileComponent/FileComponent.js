    ...
    render(){
         ...
         for(let i=0 ; i< this.state.files.length;i++){
            let f= this.state.files[i];
             ...
             files.push( 
                ...
                <img  key={i}  className="preview" onError={(e)=>{e.target.onerror = null; e.target.src="/icons/file.svg"}} src={this.state.src[i]} alt={i}/>
        ...
        return (
            <div className={this.props.inputClass}  ref={this.dropRef}>
                {this.state.loading ?  <img alt="refresh" className="refresh" src="/icons/refresh.svg"/>:null }
